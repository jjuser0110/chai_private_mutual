...
//Route::middleware(['ForceSetup'])->group(function() {
    ...
    Route::middleware(['auth'])->group(function() {
        ...
        Route::post('/submit_reset_password', [App\Http\Controllers\UserController::class, 'submit_reset_password'])->name('submit_reset_password');
        Route::post('/submit_reset_fund_password', [App\Http\Controllers\UserController::class, 'submit_reset_fund_password'])->name('submit_reset_fund_password');
    });
